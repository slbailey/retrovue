<!-- CANONICAL: This is the authoritative Canonical Rule Ledger. Root-level CANONICAL_RULE_LEDGER.md redirects here. -->
...
| **normative_text** | No output may occur beyond the BlockPlan boundary. PipelineManager enforces FramesPerBlock as the authoritative hard stop. Content MUST NOT emit past the block fence. After the fence, output transitions to pad (PADDED_GAP) or the next block. |
...
### LAW-003: Segment-Based Control [RETIRED]
...
### LAW-005: No Episodes Back-to-Back; Filler Rules [RETIRED]
...
| Status | Count | IDs |
|--------|-------|-----|
| **yes** | 13 | LAW-001, LAW-002, LAW-006, AIR-001 through AIR-007, AIR-013, CORE-001, OBS-001 |
| **retired** | 2 | LAW-003 (Phase 8 BlockPlan), LAW-005 (INV-SCHED-GRID-FILLER-PADDING) |
| **partial** | 9 | LAW-004, LAW-007, AIR-009, AIR-010, AIR-014, CORE-002, CORE-003, MET-001 |
| **no** | 7 | AIR-011, AIR-012, AIR-015, AIR-016, CORE-007, MET-002, OBS-002 |
