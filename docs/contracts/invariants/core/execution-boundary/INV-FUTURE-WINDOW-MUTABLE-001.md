...
See also: `ScheduleHorizonManagementContract_v0.1.md §4 (Lock Windows)`, `INV-EXECUTIONENTRY-LOCKED-IMMUTABLE-001`, `INV-SCHEDULEDAY-IMMUTABLE-001`.
...
- A ExecutionEntry sequence for a future window (beyond the current execution horizon end) may be replaced when new planning data is produced.
