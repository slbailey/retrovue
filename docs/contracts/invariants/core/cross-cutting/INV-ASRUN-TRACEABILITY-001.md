...
- `server/tests/contracts/test_inv_asrun_traceability.py`
- `server/tests/contracts/scheduling/test_inv_asrun_traceability.py` (CROSS-003: orphan rejected, CROSS-004: full chain traversable)
