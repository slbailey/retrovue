...
Completion (2026-02-01): tests/contracts/BoundaryDeclarationTests.cpp added; TargetFlowsFromCoreToAir calls SwitchToLive with target_boundary_time_ms and asserts switch_completion_time_ms > 0.
