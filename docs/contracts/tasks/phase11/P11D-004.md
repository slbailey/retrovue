...
---
**Done:** Proto: added violation_reason (field 7) to SwitchToLiveResponse. PlayoutEngine: kMinPrefeedLeadTimeMs=5000, lead-time check at start of deadline path returns kProtocolViolation with violation_reason. PlayoutInterface/playout_service forward violation_reason.
