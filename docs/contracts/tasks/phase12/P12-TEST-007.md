...
- Verify no LoadPreview or SwitchToLive scheduled
...
2. Test no LoadPreview in FAILED_TERMINAL:
   - Initial state: `_boundary_state = FAILED_TERMINAL`
   - Action: Attempt to trigger LoadPreview scheduling
   - Expected: LoadPreview NOT scheduled; log indicates skip

3. Test no SwitchToLive in FAILED_TERMINAL:
   - Initial state: `_boundary_state = FAILED_TERMINAL`
   - Action: Attempt to trigger SwitchToLive scheduling
