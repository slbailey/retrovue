...
_Related: [Playout Engine Contract](PlayoutEngineContract.md) · [Phase Model](../../contracts/PHASE_MODEL.md) · [Phase 6A Overview](Phase6A-Overview.md) · [Metrics Contract](MetricsAndTimingContract.md)_
...
- [Phase 6A Overview](Phase6A-Overview.md) — deferral of Renderer placement
