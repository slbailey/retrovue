...
_Related: [Playout Engine Contract](PlayoutEngineContract.md) · [Phase Model](../../contracts/PHASE_MODEL.md) · [Phase 6A Overview](Phase6A-Overview.md)_
...
- [Phase 6A Overview](Phase6A-Overview.md) — segment-based control
- [Phase6A-1 ExecutionProducer](Phase6A-1-ExecutionProducer.md) — slots and lifecycle
