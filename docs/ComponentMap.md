...
| **Producers (decode/input)** | Turning assets into frames (FFmpeg/libav boundary) | Internal C++ interfaces | `pkg/air/docs/contracts/architecture/FileProducerDomainContract.md` | `pkg/air/src/producers/` |
