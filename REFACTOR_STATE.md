...
## NEXT SUB-STEP: 7c — Move ProgramDirector Protocol and ScheduleService Protocol from channel_manager.py to retrovue/runtime/protocols.py. Update import sites. Run tests.
