...
# INV-PLAYOUT-MODULE-EXTRACTION-001: Classes extracted to pd_helpers.py.
# Re-exported here for backward compatibility.
from retrovue.runtime.pd_helpers import (  # noqa: F401
    _RawTSResponse,
    HLSAccessFilter,
    SystemMode,
    HlsDiagnosticsState,
...
class ProgramDirector:
    ...
    def _register_endpoints(self) -> None:
        ...
        from retrovue.web.api import assets_router, catalog_router, console_router, ingest_router, scheduling_router
        ...
        self.fastapi_app.include_router(assets_router)
        self.fastapi_app.include_router(console_router)  # deprecated aliases — remove after migration
        ...
        async def demo_page(channel_id: str) -> HTMLResponse:
            ...
            html_path = Path("/opt/retrovue/server/templates/demo/channel.html")
