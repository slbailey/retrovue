...
Contract: runtime/docs/contracts/INV-SINK-NO-IMPLICIT-EOF.md
...
# Load proto stubs from server/core/proto/retrovue
...
def test_inv_sink_no_implicit_eof_producer_exhaustion():
    ...
    if air_exe is None:
        pytest.skip("retrovue_air executable not found (build runtime)")
