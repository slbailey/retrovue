...
_Related: [Playout Engine Contract](../semantics/PlayoutEngineContract.md) · [Phase 6A Overview](../../archive/phases/Phase6A-Overview.md)_
...
- [Playout Engine Contract](../semantics/PlayoutEngineContract.md) — gRPC API
- [Phase 6A Overview](../../archive/phases/Phase6A-Overview.md) — segment-based control
- [Phase6A-1 ExecutionProducer](../../archive/phases/Phase6A-1-ExecutionProducer.md) — slots and lifecycle
