...
**Generated C++:** `runtime/build/playout.pb.h`, `playout.grpc.pb.h` (CMake generates from same proto).
...
| **This reference** | [docs/architecture/AirArchitectureReference.md](AirArchitectureReference.md) |
| Architecture overview | [docs/architecture/ArchitectureOverview.md](ArchitectureOverview.md) |
| Domain models | [docs/domain/](domain/) |
| **Architecture contracts** | [docs/contracts/architecture/](../contracts/architecture/) — PlayoutEngine, OutputBus, ProgramFormat, Renderer, FileProducer, etc. |
| **Development phase contracts** | [docs/contracts/phases/](../contracts/phases/) — Phase 6A, Phase 8 (milestone-specific) |
| PlayoutInstance / ProgramFormat | [contracts/architecture/PlayoutInstanceAndProgramFormatContract.md](../contracts/architecture/PlayoutInstanceAndProgramFormatContract.md) |
| OutputBus / OutputSink | [contracts/architecture/OutputBusAndOutputSinkContract.md](../contracts/architecture/OutputBusAndOutputSinkContract.md) |
...
Build output must live under **runtime/build** (see CLAUDE.md).
