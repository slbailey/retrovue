...
| LegacyPreviewSwitchModel (Retired) | `runtime/docs/contracts/coordination/LegacyPreviewSwitchModel.md` | INV-P8-SWITCH-001/002, write barriers, shadow decode, audio gate |
