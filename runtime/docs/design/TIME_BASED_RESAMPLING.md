...
**Update:** `runtime/docs/contracts/frame_selection_cadence.md`
...
**Update:** `runtime/docs/contracts/semantics/TIMING-AUTHORITY-OVERVIEW.md` § B and § E
...
**Update:** `runtime/docs/contracts/INVARIANTS-INDEX.md`
- Add INV-RESAMPLE-DETERMINISM-001

### 3.8 Test Files

**Update:** `runtime/tests/contracts/BlockPlan/CadenceSourceSyncContractTests.cpp`
- Verify behavior unchanged (advance/repeat pattern identical)

**Update:** `runtime/tests/integration/FrameCadenceIntegrationTests.cpp`
- Verify behavior unchanged

**New:** `runtime/tests/contracts/BlockPlan/TimeBasedResamplingContractTests.cpp`
...
**File:** `runtime/tests/contracts/BlockPlan/TimeBasedResamplingContractTests.cpp`
