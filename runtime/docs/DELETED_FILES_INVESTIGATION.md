...
- **Do not delete** the following unless the BlockPlan path has been fully removed or replaced and the build no longer references them:
  ...
  - `runtime/src/blockplan/AudioLookaheadBuffer.cpp`
  - `runtime/include/retrovue/blockplan/AudioLookaheadBuffer.hpp`
  - `runtime/include/retrovue/output/SocketSink.h`
...
```bash
git checkout HEAD -- \
  runtime/src/runtime/TimingLoop.cpp \
  runtime/src/blockplan/PipelineManager.cpp \
  runtime/src/blockplan/AudioLookaheadBuffer.cpp \
  runtime/include/retrovue/blockplan/AudioLookaheadBuffer.hpp \
  runtime/include/retrovue/output/SocketSink.h
