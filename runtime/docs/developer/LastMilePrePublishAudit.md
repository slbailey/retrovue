...
| **Color range** | ⚠️ **Not set** | No `color_range`, `color_primaries`, `color_transfer`, or `colorspace` set in `runtime/src` or `runtime/include`. We rely on libav/decoder defaults. |
