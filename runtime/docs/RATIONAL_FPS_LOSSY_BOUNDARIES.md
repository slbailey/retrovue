...
Guardrail:
- `runtime/scripts/check_rationalfps_hotpath.sh` enforces no `1.0/fps` or `1000.0/fps` regressions in blockplan hot path + relevant contracts, and forbids `DeriveRationalFPS(30.0|29.97|59.94|23.976)` in targeted tests.
