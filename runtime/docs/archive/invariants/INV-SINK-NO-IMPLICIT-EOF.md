...
- `runtime/tests/contracts/test_inv_sink_no_implicit_eof.py` — Python integration test
- `runtime/tests/contracts/InvSinkNoImplicitEofTests.cpp` — C++ unit test (future)
