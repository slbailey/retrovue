...
- **Core:** `server/docs/contracts/runtime/ScheduleManagerContract.md` (deprecated section 10)
- **AIR 8.3 (Retired):** `runtime/docs/contracts/coordination/LegacyPreviewSwitchModel.md`
