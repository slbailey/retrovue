// AIR vNext — MuxInterleaver.
//
// Ported verbatim from runtime/include/retrovue/playout_sinks/mpegts/
// MuxInterleaver.hpp with only namespace (retrovue::playout_sinks::mpegts ->
// retrovue::air) and include-guard changes, and with the
// RETROVUE_FFMPEG_AVAILABLE guard removed (air/ always has FFmpeg).
//
// All invariants, comments, and logic are preserved.

#ifndef AIR_MUX_INTERLEAVER_HPP_
#define AIR_MUX_INTERLEAVER_HPP_
...
#endif  // AIR_MUX_INTERLEAVER_HPP_
