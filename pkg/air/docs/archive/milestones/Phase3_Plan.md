<!-- ⚠️ Historical document. Superseded by: [Contracts index](../../contracts/README.md). -->
...
- Deliver `ProgramOutput` interfaces for headless and preview consumption.
...
2. **Renderer layer**
   - Define `ProgramOutput` interface and provide headless + preview implementations.
