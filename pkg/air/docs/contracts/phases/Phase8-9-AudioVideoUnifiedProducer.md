...
_Related: [Phase Model](../../contracts/PHASE_MODEL.md) · [Phase 8 Overview](Phase8-Overview.md) · [Phase8-6 Real MPEG-TS E2E](Phase8-6-RealMpegTsE2E.md) · [Phase8-7 Immediate Teardown](Phase8-7-ImmediateTeardown.md) · [Phase8-8 Frame Lifecycle and Playout Completion](Phase8-8-FrameLifecycleAndPlayoutCompletion.md)_
