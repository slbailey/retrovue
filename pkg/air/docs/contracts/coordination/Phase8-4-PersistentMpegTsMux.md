...
- **Jitter protection:** The output path (OutputBus and/or OutputSink) must provide jitter protection per the [OutputBus & OutputSink Contract](OutputBusAndOutputSinkContract.md). This phase’s PCR/PTS and continuity guarantees assume that requirement is satisfied.
