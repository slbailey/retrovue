...
_Related: [Playout Engine Contract](../semantics/PlayoutEngineContract.md) · [PlayoutInstance & ProgramFormat](../semantics/PlayoutInstanceAndProgramFormatContract.md) · [OutputBus & OutputSink](OutputBusAndOutputSinkContract.md)_
...
- [PlayoutInstanceAndProgramFormatContract](../semantics/PlayoutInstanceAndProgramFormatContract.md) — PlayoutInstance owns ProducerBus(es).
...
- [LegacyPreviewSwitchModel (Retired model)](LegacyPreviewSwitchModel.md) — Core-driven bus switching.
