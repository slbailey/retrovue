...
_Related: [MasterClock Domain](../../archive/domain/MasterClockDomain.md); [Architecture Overview](../../overview/ArchitectureOverview.md)_

# MasterClock Contract

**Authoritative definition of the clock law** (MasterClock is the only source of "now"; CT never resets once established) **lives in [PlayoutInvariants-BroadcastGradeGuarantees.md](../laws/PlayoutInvariants-BroadcastGradeGuarantees.md).** This contract specifies component-level behavior that satisfies that law.
