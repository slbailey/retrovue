...
class TestP6T001OffsetCalculation:
    ...
    def test_offset_calculated_from_segment_start(
        self, schedule_service: ScheduleManagerBackedScheduleService
    ):
...
class TestIllusionGuarantee:
    ...
    def test_litmus_scenario(self, schedule_service: ScheduleManagerBackedScheduleService):
        """
    ...
    def test_multiple_viewers_same_offset(
        ...
        plan1 = schedule_service.get_playout_plan_now("test-channel", at_time)
        plan2 = schedule_service.get_playout_plan_now("test-channel", at_time)
        plan3 = schedule_service.get_playout_plan_now("test-channel", at_time)
