...
class NormalProducer(Producer):
    ...
    def __init__(self, channel_id: str, configuration: dict[str, Any]):
        ...
        self._endpoint = configuration.get("output_url", f"normal://{channel_id}")
    ...
    def on_paced_tick(self, t_now: float, dt: float) -> None:
        """Advance normal producer state using pacing ticks."""
        # TODO: Implement tick-driven playback loop
        pass