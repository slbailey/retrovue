...
class EmergencyProducer(Producer):
    ...
    Stub implementation that honours pacing and teardown contracts.
    """
    ...
    def __init__(self, channel_id: str, configuration: dict[str, Any]):
        ...
        self._endpoint = configuration.get("output_url", f"emergency://{channel_id}")
    ...
    def on_paced_tick(self, t_now: float, dt: float) -> None:
        """Advance emergency producer state using pacing ticks."""
        # TODO: Implement tick-driven loop for emergency mode
        pass