> **Replaced:** The authoritative repository layout lives in [`../_standards/repository-conventions.md`](../_standards/repository-conventions.md). This document remains as historical background.
